...
var _default = function _default(Observer, options) {
  ...
  var observe = function observe(el, cb) {
    if (callbacks.has(el)) {
      callbacks.set(el, [].concat((0, _toConsumableArray2.default)(callbacks.get(el)), [cb]));
    } else {
      callbacks.set(el, [cb]);
      observer.observe(el);
    }
...
exports.default = _default;
},{"@babel/runtime/helpers/toConsumableArray":"../node_modules/@babel/runtime/helpers/toConsumableArray.js"}],"js/image.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.bindImage = void 0;
...
// })
var _createObserver = (0, _observer.default)(_resizeObserverPolyfill.default),
    observe = _createObserver.observe;

var bindImage = function bindImage(img) {
  ...
  var onSizeChange = function onSizeChange(entry) {
    update(entry.contentRect.width);
  };
...
exports.bindImage = bindImage;
(0, _toConsumableArray2.default)(document.querySelectorAll('img[data-srcset]')).forEach(bindImage);
},{"@babel/runtime/helpers/toConsumableArray":"../node_modules/@babel/runtime/helpers/toConsumableArray.js","resize-observer-polyfill":"../node_modules/resize-observer-polyfill/dist/ResizeObserver.es.js","./utils/observer":"js/utils/observer.js"}],"js/slider.js":[function(require,module,exports) {
"use strict";
...
},{"buffer":"../node_modules/buffer/index.js"}],"js/excerpt.js":[function(require,module,exports) {
"use strict";
...
var containsMultiple = false;
var textExcerpt;

var typeInto = function typeInto(el, text) {
...
var createSentenceEl = function createSentenceEl(url) {
  var el = document.createElement(url ? 'a' : 'div');
  el.classList.add('excerpt__text');
  el.classList.add("excerpt__text--bracket-".concat((0, _lodash.random)(1, 4)));
  if (url) el.href = url;
  return el;
};

var createCoverEl = function createCoverEl(_ref) {
  ...
  (0, _image.bindImage)(img);
  el.appendChild(img);
  return el;
};

var layoutMain = document.querySelector('.layout__main');

var checkTextFit = function checkTextFit(el) {
  return el.offsetHeight < layoutMain.offsetHeight;
};

var returnOnNext = false;
(0, _toConsumableArray2.default)(document.querySelectorAll('.excerpt--multiple')).forEach(function (el) {
  if (!containsMultiple) {
    textExcerpt = document.querySelector('.home__excerpt');
    textExcerpt.addEventListener('mouseenter', function () {
      textExcerpt.classList.add('slow-down');
    });
    textExcerpt.addEventListener('mouseleave', function () {
  ...
  var nextSentence = function nextSentence() {
    return fetch(url).then(function (r) {
      return r.json();
    }).then(function (_ref2) {
      var text = _ref2.text,
      ...
      return new Promise(function (resolve) {
        return typeInto(span, text, resolve);
      });
    }).then(function () {
      return wait(1000);
    }).then(nextSentence);
...
},{"@babel/runtime/helpers/toConsumableArray":"../node_modules/@babel/runtime/helpers/toConsumableArray.js","./image":"js/image.js","lodash":"../node_modules/lodash/lodash.js"}],"js/main.js":[function(require,module,exports) {
"use strict";
...
require("./excerpt");
},{"./image":"js/image.js","./slider":"js/slider.js","./about":"js/about.js","./excerpt":"js/excerpt.js"}]},{},["js/main.js"], null)
